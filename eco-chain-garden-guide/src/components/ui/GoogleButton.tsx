export const GoogleButton = ({ label }: { label: string }) => (
  <button
    type="button"
    className="w-full h-12 bg-white border border-outline-variant rounded-lg flex items-center justify-center gap-3 text-label-md text-on-surface hover:bg-surface-container transition-colors"
  >
